...
public class Program {
    ...
    private double packageBService;
    private double storageSmall;
    private double storageLarge;
    private double boxesSmall;
    private double boxesLarge;

    public double getPackageAService() {
        return packageAService;
    }

    public void setPackageAService(double packageAService) {
        this.packageAService = packageAService;
    }

    public double getPackageBService() {
        return packageBService;
    }

    public void setPackageBService(double packageBService) {
        this.packageBService = packageBService;
    }
